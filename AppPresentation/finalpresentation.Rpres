...
This presentation will briefly but comprehensively pitch for predicting the next word.
...
* The next word prediction app is hosted on shinyapps.io: [https://mohabdiab.shinyapps.io/ShinyApp/](https://mohabdiab.shinyapps.io/ShinyApp/)


* The whole code of this application, as well as all the milestone report, related scripts, this presentation  etc. can be found in this GitHub repo: [https://github.com/diabmohab/Word-Detection-Project-](https://github.com/diabmohab/Word-Detection-Project-)

* The Milestone Report on Rpubs : [https://rpubs.com/MohabDiab/milestonereport](https://rpubs.com/MohabDiab/milestonereport)
